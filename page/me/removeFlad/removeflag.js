...
export default class Me extends React.Component{
    ...
    _loadData(){
        this.languageDeo.fetch('flag_language_key')
            .then(result=>{
                result.forEach((a,i,arr)=>{
                    a.remove=false;
                })
    ...
    _onSave(){
        let mm=this.state.dataArray;
        if(this.changesValues){
            this.changesValues.forEach((a,i,arr)=>{
